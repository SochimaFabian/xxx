...
<div class="stories">
    ...
    <div class="stories__content">
        <button class="story story--has-story">
            ...
            <span class="story__user">@khusanov</span>
        </button>
        <button class="story story--has-story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story2.jpeg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@sher__1</span>
        </button>
        <button class="story story--has-story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story3.jpg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@akee.013</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story4.jpeg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@xamdam_me</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story1.jpg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@barsa_fanatka</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story6.jpg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@dili.me</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story7.jpg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@khamdamov1</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story8.jpg') }}" alt="User Picture">
                </div>
            </div>
            <span class="story__user">@diyor_wtf</span>
        </button>
        <button class="story">
            <div class="story__avatar">
                <div class="story__border">
                ...
                <div class="story__picture">
                    <img src="{{ asset('home/assets/story9.jpeg') }}" alt="User Picture">
                </div>
            </div>
