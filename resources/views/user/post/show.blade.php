...
@section('title')
    {{ ucwords($post->user->username) }} • Post
@endsection
                    ...
                    <article class="post">
                        <div class="post__header">
                            <div class="post__profile">
                                <a href="{{ route('p.show', $post->user->username) }}" target="_blank" class="post__avatar">
                                    <img @if (!empty($post->user->profile->image)) src="{{ asset($post->user->profile->image) }}"
                                @else
                                src="{{ asset('home/assets/default-user.png') }}" @endif
                                        alt="User Picture">
                                </a>
                                <a href="{{ route('p.show', $post->user->username) }}" target="_blank"
                                    class="post__user"><span>@</span>{{ $post->user->username }}</a>
                            </div>

                            <button class="post__more-options" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        ...
                        <div class="post__content">
                            <div class="post__medias">
                                <img class="post__media" src="{{ asset($post->image) }}" alt="Post Content">
                            </div>
                        </div>
                            ...
                            <div class="post__infos">
                                <div class="post__likes">
                                    <a href="#" class="post__likes-avatar">
                                        <img src="{{ asset('home/assets/story5.jpg') }}" alt="User Picture">
                                    </a>
                                ...
                                <div class="post__description">
                                    <span>
                                        <a class="post__name--underline" href="{{ route('p.show', $post->user->username) }}"
                                            target="_blank"><span>@</span>{{ $post->user->username }}</a>
                                        {{ $post->description }}
                                    </span>
                                </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <ul class="list-group d-flex align-items-center justify-content-center">
                                        ...
                                        <form action="{{ route('post.destroy', $post->id) }}" class="list-group-item w-100 d-inline" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button style="background-color:transparent;border:none" class="w-100 text-danger">
                                                <b>Delete</b>
                                            </button>
                                        </form>
                                        {{--  @endif  --}}
                                        <li class="list-group-item w-100">A third item</li>
                                        <li class="list-group-item w-100">A fourth item</li>
                                        <li class="list-group-item w-100">And a fifth one</li>
                                        <li class="list-group-item w-100">A second item</li>
                                        <li class="list-group-item w-100">A third item</li>
                                        <li class="list-group-item w-100">A fourth item</li>
                                        <li class="list-group-item w-100">And a fifth one</li>
                                        <li class="list-group-item w-100">A second item</li>
